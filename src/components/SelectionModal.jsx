      ...
      <div className="relative w-full max-w-2xl bg-[#ffffff] rounded-t-[2rem] md:rounded-t-[3rem] shadow-2xl p-5 md:p-10 flex flex-col gap-8 animate-slide-up h-[85vh] overflow-hidden">
        ...
        <div className="flex flex-col gap-6 flex-1 overflow-hidden">
            ...
            <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-sepia-dark tracking-tight">Select Recitation</h3>
                <button 
                  onClick={onClose}
            ...
            <div className="w-full p-1.5 bg-[#f9f5eb] rounded-[2rem] flex items-center shrink-0">
                <button
                    ...
                    className={`flex-1 py-3 px-6 rounded-[1.7rem] text-sm font-bold tracking-widest uppercase transition-all duration-300 ${
                        activeTab === 'chapter' ? 'bg-[#ffffff] text-gold' : 'text-sepia-dark'
                    }`}
                >
                    Surah
                </button>
                <button
                    ...
                    className={`flex-1 py-3 px-6 rounded-[1.7rem] text-sm font-bold tracking-widest uppercase transition-all duration-300 ${
                        activeTab === 'juz' ? 'bg-[#ffffff] text-gold' : 'text-sepia-dark/40 border-transparent'
                    }`}
                >
                    Juz
                </button>
            ...
            {/* List Wrapper - Borrowed logic from Dropdown.jsx's list */}
