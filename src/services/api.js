...
export async function fetchVerses(mode, id) {
  ...
  const res = await fetch(
    `${API_BASE}/verses/${endpoint}?language=en&translations=20,161,57&fields=text_uthmani_tajweed&audio=${DEFAULT_RECITER}&per_page=${VERSES_PER_PAGE}&words=true&word_fields=text_uthmani_tajweed`
  );
